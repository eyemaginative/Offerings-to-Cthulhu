...
AC_DEFUN([_BITCOIN_QT_CHECK_STATIC_PLUGINS],[
  ...
  AC_TRY_LINK([
    ...
    $1],
    [return 0;],
    [AC_MSG_RESULT(yes); QT_LIBS="$2 $QT_LIBS -lsecur32 -lcrypt32 -lbcrypt"],
