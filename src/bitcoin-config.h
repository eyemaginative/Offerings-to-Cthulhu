...
#define PACKAGE_BUGREPORT "info@Offerings.cc"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Offerings Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Offerings Core 1.6.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "Offerings"
