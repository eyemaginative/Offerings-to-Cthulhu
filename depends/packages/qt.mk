...
$(package)_config_opts_mingw32 += -no-feature-xdgdesktopportal
...
define $(package)_preprocess_cmds
  ...
  sed -i.old "s|int(std::size(buf))|int(sizeof(buf)/sizeof(buf[0]))|" qtbase/src/corelib/text/qlocale_win.cpp
