...
2. Deploy the ritual-consensus binary to vps3 (RitualBonus in main.cpp) BEFORE block ~1,270,346
   so chaos and vps3 do not split. Safe (inert until that height).
